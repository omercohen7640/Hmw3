...
pHash CreateDictionary(){
    pHash p_dic;
    /*
    HashFunc p_hashfunc= &(HashFunc)HashWord; //pointer to hashFunc
    ...
    */
    p_dic = HashCreate((DIC_SIZE),HashWord,PrintEntry,CompareWords,GetEntryKey,DestroyEntry);//pointer to compareFunc
    return p_dic;
}
